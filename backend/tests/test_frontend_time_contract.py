...
def test_price_chart_uses_local_receive_time_for_sim_ticks():
    source = PRICE_CHART.read_text(encoding="utf-8")

    assert "chartTimeMs: point.receivedAt" in source


def test_market_store_tracks_receive_time_for_chart_ticks():
