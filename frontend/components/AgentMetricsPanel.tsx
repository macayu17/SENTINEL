...
export default function AgentMetricsPanel() {
  ...
  return <section className="agent-ledger">
    <div className="section-heading"><h2>Agent ledger · {agents.length} participants</h2><label>State <select value={filter} onChange={e => setFilter(e.target.value)}><option value="all">All agents</option><option value="active">Active</option><option value="halted">Halted</option></select></label></div>
